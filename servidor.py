...
def inicio():
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if download_url:
                mensaje = f'✨ ¡Listo! <br><br> <a href="{download_url}" target="_blank" class="btn-descarga">Descargar Archivo</a>'
            else:
                mensaje = "⚠️ No se pudo generar el link."
        except Exception as e:
            mensaje = "⚠️ Error al procesar el video."
